...
\Breakdance\ElementStudio\registerElementForEditing(
    "IcebergCustomElements\\WrapperDiv",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class WrapperDiv extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' => ['accepts' => 'image_url', 'path' => 'design.background.image'], '1' => ['accepts' => 'image_url', 'path' => 'design.background.overlay.image'], '2' => ['path' => 'settings.advanced.attributes[].value', 'accepts' => 'string']];
    }
