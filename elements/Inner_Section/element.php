...
\Breakdance\ElementStudio\registerElementForEditing(
    "IcebergCustomElements\\InnerSection",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class InnerSection extends \Breakdance\Elements\Element
{
...
{% endif %}',
    ...
    {
        return ['0' => ['accepts' => 'video', 'path' => 'design.background.video'], '1' => ['accepts' => 'image_url', 'path' => 'design.background.video_settings.fallback_image'], '2' => ['accepts' => 'image_url', 'path' => 'design.background.image'], '3' => ['accepts' => 'gallery', 'path' => 'design.background.slideshow'], '4' => ['accepts' => 'image_url', 'path' => 'design.background.overlay.image'], '5' => ['path' => 'settings.advanced.attributes[].value', 'accepts' => 'string']];
    }
